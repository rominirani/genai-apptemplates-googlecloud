...
|Provide an API for the Vertex AI PaLM Text Model for your client applications.|[text-predict-cloudfunction - Python](text-predict-cloudfunction), [text-predict-cloudfunction - Java](text-predict-cloudfunction-java)|Cloud Functions v2, Python, Java|
