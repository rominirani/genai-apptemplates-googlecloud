...
|Provide an API for the Vertex AI PaLM Text Model for your client applications.|1. [text-predict-cloudfunction - Python](text-predict-cloudfunction)<br/>2. [text-predict-cloudfunction - Java](text-predict-cloudfunction-java)|Cloud Functions v2, Python, Java, langchain4j|
